function params = getFilenamesKitti12( params )
%GETFILENAMESKITTI12
% get KITTI 2012 dataset filenames

  % base filenames
  params.fnIm1 =sprintf('%06d_10.png',params.shot);
  params.fnIm2 =sprintf('%06d_11.png',params.shot);
